...
\dfn{Contatore monotòno}{
  Un \newfancyglitter{contatore monotòno} (o logical clock) è una meta-variabile il cui valore si incrementa quando un processo esegue una certa operazione o azione. 
  ...
  In una computazione, due istanze $a_i$ e $a_j$ di un'azione $a$ sono temporalmente ordinate: $c_i < c_j \Leftrightarrow a_i$ è avvnuta prima di $a_j$.
}
