...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.7\textwidth]{01/sw.png}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.7\textwidth]{01/p.png}
	\end{center}
	\caption{Partnership.}
\end{figure}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.7\textwidth]{01/cs.png}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.7\textwidth]{01/c.png}
	\end{center}
	\caption{Conformist.}
\end{figure}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.7\textwidth]{01/shared kernel.png}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.7\textwidth]{01/anti-corruption layer.png}
	\end{center}
	\caption{Shared Kernel.}
\end{figure}
...
\dfn{Tactical DDD}{
	Il Tactical DDD si occupa di implementare un subsomain model in un bounded context.
}
