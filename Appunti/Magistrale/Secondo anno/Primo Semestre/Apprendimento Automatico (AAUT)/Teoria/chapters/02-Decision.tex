...
\begin{itemize}
	\item I dati non sono sempre completamente descritti.
	\item Scartare i valori mancanti è un grande spreco di dati.
	\item Due problemi:
	      \begin{itemize}
		      \item Come scegliere come splittare le features quando ci sono valori mancanti?
		      \item Come splittare un campione in cui la feature su cui si fa lo splittig ha un valore mancante?
	      \end{itemize}
\end{itemize}

\dfn{Missing Values}{
	Dato un training set $D$ e una feature $a$ assumiamo $\tilde{D}$ come sottoinsieme dei campioni in $D$ che hanno valore $a$, $\tilde{D}^v$ come sottoinsieme dei campioni in $\tilde{D}$ che hanno valore $a^v$, $\tilde{D}_k$ come sottoinsieme dei campioni in $\tilde{D}$ appartenenti alla $k$-esima classe.
	Assegnamo un peso $w_x$ a ogni campione $x$ e definiamo:

	\begin{itemize}
		\item La proporzione di campioni senza valori mancanti:
		      \[\rho = \frac{\sum_{x \in \tilde{D}} w_x}{\sum_{x \in D} w_x}\]
		\item La proporzione della $k$-esima classe in tutti i campioni senza valori mancanti:
		      \[\tilde{p}_k = \frac{\sum_{x \in \tilde{D}_k} w_x}{\sum_{x \in \tilde{D}} w_x} \quad (1 \leq k \leq |\mathcal{Y}|)\]
		\item La proporzione di cambioni con valore $a^v$ in tutti i campioni senza valori mancanti:
