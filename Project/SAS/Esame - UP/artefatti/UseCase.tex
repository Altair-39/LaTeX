...
\begin{flushleft}
    \begin{center}
        ...
        \begin{longtable}{ | p{1.3cm} | p{7.5cm} | p{7.5cm} |}
            ...
            \centering\textbf{\textcolor{2}{1b.1}} & Aggiunge un turno di cucina e, opzionalmente, segna un luogo.  & \cellcolor{RedPastel}Esiste già un turno in quell'orario. \\\hline
           & \textit{Termina il Caso d'Uso}& \\\hline
            \hline
            \end{longtable}
...
\begin{flushleft}
    \begin{center}
        ...
        \begin{longtable}{ | p{1.3cm} | p{7.5cm} | p{7.5cm} |}
            ...
            \centering\textbf{\textcolor{2}{5a.1a.1}} &  Rimuove la scadenza. & \cellcolor{RedPastel} Il turno non ha una scadenza impostata.\\\hline
