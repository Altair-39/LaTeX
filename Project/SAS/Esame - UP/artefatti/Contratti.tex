...
\begin{itemize}
    ...
    \item è stata creata un'associazione \textbf{si svolge in} tra \underline{\textit{turnoCucina}} e \textif{Evento};
...
\begin{itemize}
   \item \textlangle $ $ per ogni Compito $c$ \textbf{presente in} \underline{turno} \textrangle:
    ...
    \end{itemize}
    \item l'associazione \textbf{contiene} tra \underline{\textit{turno}} e $tt$ è stata eliminata;
    \item l'associazione \textbf{gestito da} tra \underline{\textit{turnoServizio}} e \textif{org} è stata eliminata;
\item l'associazione \textbf{si svolge in} tra \underline{\textit{turnoCucina}} e \textif{Evento} è stata eliminata;
    \item l'istanza $tc$ di TurnoCucina cessa di esistere.
\end{itemize}
...
\begin{itemize}
   ...
   \item è stata creata un'associazione \textbf{si svolge in} tra \underline{\textit{turnoServizio}} e \textif{Evento};
...
\begin{itemize}
 ...
 \item l'associazione \textbf{gestito da} tra \underline{\textit{turnoServizio}} e \textif{org} è stata eliminata;
\item l'associazione \textbf{si svolge in} tra \underline{\textit{turnoServizio}} e \textif{Evento} è stata eliminata;
